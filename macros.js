...
MACROS =    
    ...
    , "%aoe-4-with-black%":                         "<span class='nobr'> <img class='icon' src='images/aoe-4-with-black.svg'></span>"
    , "%aoe-circle%":                               "<span class='nobr'> <img class='icon' src='images/aoe-circle.svg'></span>"
    , "%aoe-circle-with-middle-black%":             "<span class='nobr'> <img class='icon' src='images/aoe-circle-with-middle-black.svg'></span>"
    , "%aoe-circle-with-side-black%":               "<span class='nobr'> <img class='icon' src='images/aoe-circle-with-side-black.svg'></span>"
    ...
    , "%aoe-line-6-with-black%":                    "<span class='nobr'> <img class='icon' src='images/aoe-line-6-with-black.svg'></span>"
    , "%aoe-triangle-2-side%":                      "<span class='nobr'> <img class='icon' src='images/aoe-triangle-2-side.svg'></span>"
    , "%aoe-triangle-2-side-with-black%":           "<span class='nobr'> <img class='icon' src='images/aoe-triangle-2-side-with-black.svg'></span>"
    , "%aoe-triangle-3-side-with-corner-black%":    "<span class='nobr'> <img class='icon' src='images/aoe-triangle-3-side-with-corner-black.svg'></span>"
